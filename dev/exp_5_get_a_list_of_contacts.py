...
##        del parents
        ...
        for parent in target_tree.xpath(f"//rpIndName/.. | //rpOrgName/.."):
            ...
            for child in children:
                #print(f"\t\t{child.tag}, {child.text}")
                #kids = parent.xpath(f"./{child.tag}/descendant::*")
                #for kid in kids:
                #    print(kid)
                #if parent.xpath(f"./{child.tag}/descendant::*"):
                #    kid = parent.xpath(f"./{child.tag}/descendant::*")[-1]
                #    print(kid.tag)
                #user_dict = contact_dict[rpOrgName.text]
            ...
            contact_children = contact_root.iterchildren()
            child_count = 0
            for contact_child in contact_children:
                #print(f"\t\t{contact_child.tag}, {contact_child.text}")
            ...
            if "rpOrgName" in locals().keys(): del rpOrgName

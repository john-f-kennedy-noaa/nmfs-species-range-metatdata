...
def create_feature_class(project_gdb="", metadata_workspace=""):
    try:
        # Imports
        from lxml import etree
        from io import StringIO
        ...
        print("Create a template polygon")
        ...
        print("Copy features to feature class")
...
##        dataset_md.tags = ""
##        dataset_md.summary = ""
##        dataset_md.description = ""
##        dataset_md.credits = ""
##        dataset_md.accessConstraints = ""
##        dataset_md.save()
...
##
##        xml_str = etree.tostring(eainfo_root, encoding='UTF-8').decode()
##        #print(xml_str)

        # Import the standard-format metadata content to the target item
        #dataset_md.importMetadata(xml)
        #dataset_md.save()
        #dataset_md.synchronize("ALWAYS")
        #dataset_md.save()
        #dataset_md.reload()
...
def fun_with_xml(species_range_fc="", fc_metadata_xml_file=""):
    try:
        # Imports
        from lxml import etree
        from io import StringIO
...
def main(project_gdb="", metadata_workspace=""):
    try:
        ...
        #pretty_format_xml_file(rf"{project_folder}\{metadata_workspace}\SpeciesRangeTemplate.xml")
        ...
        if FunWithXml:
            species_range_fc     = rf"{project_gdb}\SpeciesRangeTemplate"
            fc_metadata_xml_file = rf"{project_folder}\{metadata_workspace}\SpeciesRangeTemplate.xml"
            fun_with_xml(species_range_fc=species_range_fc, fc_metadata_xml_file=fc_metadata_xml_file)
            del fc_metadata_xml_file, species_range_fc
        else:
            pass
        del FunWithXml
        ...
        # Imports
        del pretty_format_xml_file, tempfile
